...
import stop from "./images/1stop.png";
import pinak from "./images/pinak.png";
import dw from "./download/SIMANTA2.1_UPDATE_RESUME.pdf";
import tl from "./images/tail.png";
import java from "./images/java.png";
import c from "./images/c-programming.png";
import js from "./images/js.png";
import wp from "./images/wordpress.png";
import md from "./images/mongodb.svg";
...
const Home = () => {
  return (
    <>
      <motion.div
        className="bg-purple-800 dark:bg-gray-800  min-h-screen"
        initial={{ y: 1000 }}
        animate={{ y: [0, -100, 0] }}
        transition={{
          duration: 3,
      ...
      >
        <div className="grid py-14  px-4 mx-auto  mb-0 max-w-screen-xl lg:gap-8 xl:gap-0 lg:py-14 lg:grid-cols-12 ">
          <div className="place-self-center mr-auto lg:col-span-7">
            ...
            <p className="mb-6 max-w-2xl font-bold text-white lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              <Typewriter
                options={{
                  strings: [
          ...
          <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            ...
            >
              ...
              <p className="text-gray-500 dark:text-gray-400">
                I am so good in Java Programming. I am working on Java
                programming since 2020. I came top 1% in NPTEL Programming in
                java Exam 2022.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <p className="text-gray-500 dark:text-gray-400">
                I am also good in C Programming. I am working on C programming
                since 2020
              </p>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <p className="text-gray-500 dark:text-gray-400">
                I have been working with ReactJS from the last 2.5 years and
                during this period I have learned many things and acquired some
                skills. I worked on ReactJS during my internship at Pinak Idea
                Lab Private Limited.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <p className="text-gray-500 dark:text-gray-400">
                NodeJS is an Open-source server environment. I have worked on
                NodeJS from the last 1.5 years
              </p>
            </motion.div>
            <motion.div
              initial={{ y: 1000 }}
            ...
            >
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Javascript is very popolar programming language , It can be used
                for both frontend and backend Development. I am familiar with
                some javascript frameworks ReactJS,NodeJS,ExpressJS etc. and I
                am also familiar with core Javascript concept.
              </p>
            </motion.div>
            <motion.div
              initial={{ y: 1000 }}
            ...
            >
              ...
              <p className="text-gray-500 dark:text-gray-400">
                MongoDB is a popular Non-relational database and I have worked
                on MongoDB since last 1.5 years
              </p>
            </motion.div>
            <motion.div
              initial={{ y: 1000 }}
            ...
            >
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Python is a very popular programming language in nowadays. I am
                familiar with python programming since 2020 and Currently I am
                working with python.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Wordpress is very popular website bulider and content Management
                system. I worked on Wordpress during my internship at Pinak Idea
                Lab Private Limited.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-500 dark:text-gray-400">
                I am familiar with HTML5 since 2019. I worked on HTML5 during my
                summer internship at 1STOP.
              </p>
            </motion.div>
            <motion.div
              initial={{ y: 1000 }}
            ...
            >
              ...
              <p className="text-gray-500 dark:text-gray-400">
                I am familiar with CSS since 2019. I worked on CSS during my
                summer internship at 1STOP.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <p className="text-gray-500 dark:text-gray-400">
                it is a popular open source CSS framework, I worked on Tailwind
                CSS during my internship at Pinak Idea Lab Private Limited.
              </p>
            </motion.div>
            <motion.div
              initial={{ y: 1000 }}
            ...
            >
              ...
              <p className="text-gray-500 dark:text-gray-400">
                It is a open-source relational Database Management System. I
                worked on MYSQL during my summer internship at 1STOP.
              </p>
            </motion.div>
          </div>
        </div>
