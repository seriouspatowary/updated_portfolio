    ...
    <nav className="w-full bg-purple-800 shadow">
      <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
        ...
        <div>
          ...
          >
            ...
            <div className="mt-3 space-y-2 lg:hidden md:hidden">
              <Link
                to={"/contact"}
                className="inline-block w-full px-4 py-2 text-center text-black bg-white rounded-md shadow hover:bg-gray-800"
              >
                Contact me
              </Link>
            </div>
        ...
        <div className="hidden space-x-2 md:inline-block">
          <Link
            to={"/contact"}
            className="px-4 py-2 text-black font-bold rounded-md shadow hover:bg-gray-400 bg-white"
          >
            Contact me
          </Link>
        </div>
